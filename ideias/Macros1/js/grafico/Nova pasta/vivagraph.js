...
Viva.Graph.graph = function () {
    ...
    var graphPart = {
        ...
        addLink : function (fromId, toId, data) {
            ...
            var link = new Viva.Graph.Link(fromId, toId, dado);
        ...
        forEachNode : function (callback) {
            ...
            for (node in nodes) {
                ...
                //if (nodes.hasOwnProperty(node)) {            //Sistema Macros
...
Viva.Graph.View.renderer = function (graph, settings) {
    ...
    return {
         ...
         */
        moveTo: function (x, y) { //incluido em 14/4/2014 - esse código não estava originalmente no vivagraph versão 0.4
